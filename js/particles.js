...
(function() {
  ...
  let W, H;
  const particles = [];
  var currentChars = '道鬼仙魔命劫缘煞符箓咒印阵法术灵魂魄';
  var currentColor = 'rgba(139,0,0,';
  var currentOpacity = [0.04, 0.08];
  ...
  window.updateParticlesTheme = function(theme) {
    ...
    // Smoothly update existing particles with new chars and colors
